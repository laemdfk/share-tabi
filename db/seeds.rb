...
Post.create!(
  [
    {titile: '大沢池の景色', post_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post1.jpg"), filename:"sample-post1.jpg"), body: '季節や時間によって、見える景色が違いそう。次は紅葉の頃に行ってみようか', enduser_id: endusers[1].id },
